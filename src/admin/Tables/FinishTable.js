  ...
  const fetchSubmittedData = async () => {
    try {
      const response = await axios.get(
        "https://singhania-inventory.onrender.com/api/lots/completed/finish",
        {
      ...
      <div className="w-full mt-6 bg-white border-nav border-2 rounded-lg">
        <div className="flex ml-4 mt-4 justify-between items-center">
          <div className="text-title font-bold">
            Finish Table <br /> Total: {submittedData.length}
          </div>
                  ...
                  <React.Fragment key={index}>
                    {entry.entries.map((subEntry, subIndex) => (
                      <tr key={subEntry._id}>
                        ...
                        {/* <td className="px-6 py-4 whitespace-nowrap">{formatDateTime(subEntry.createdAt) || "N/A"}</td> */}
                        <td className="px-6 py-4 whitespace-nowrap">
                          <button
                ...
                <div className="border-2 w-full sm:w-[500px] h-full rounded-lg mt-3 shadow-sm shadow-darkgray">
                  <label className="block text-lg font-login ml-4 mt-4 text-gray-700">
                    ...
                    <input
                      className="block w-[300px] mt-2 p-2 border-2 rounded mb-4 cursor-not-allowed"
                      name="challanNumber"
                      value={selectedEntry?.subEntry.challanNumber || ""}
                      readOnly
                    />
                  </label>
                </div>
                ...
                <div className="border-2 w-full sm:w-[500px] h-full rounded-lg mt-3 shadow-sm shadow-darkgray">
                  <label className="block text-lg font-login ml-4 mt-4 text-gray-700">
                    ...
                    <input
                      className="block w-[300px] mt-2 p-2 border-2 rounded mb-4"
                      name="kg"
                      value={selectedEntry?.subEntry.kg || ""}
                      onChange={handleChange}
                    />
                  </label>
                </div>
                <div className="border-2 w-full sm:w-[500px] h-full rounded-lg mt-3 shadow-sm shadow-darkgray">
                  <label className="block text-lg font-login ml-4 mt-4 text-gray-700">
                    ...
                    <input
                      className="block w-[300px] mt-2 p-2 border-2 rounded mb-4"
                      name="meter"
                      value={selectedEntry?.subEntry.meter || ""}
                      onChange={handleChange}
                    />
                  </label>
                </div>
                <div className="border-2 w-full sm:w-[500px] h-full rounded-lg mt-3 shadow-sm shadow-darkgray">
                  <label className="block text-lg font-login ml-4 mt-4 text-gray-700">
                    ...
                    <input
                      className="block w-[300px] mt-2 p-2 border-2 rounded mb-4"
                      name="roll"
                      value={selectedEntry?.subEntry.roll || ""}
                      onChange={handleChange}
                    />
                  </label>
                </div>
