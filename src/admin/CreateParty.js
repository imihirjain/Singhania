      ...
      <div className="mx-auto p-4 flex flex-col items-center">
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="mb-4 p-6 ">
          ...
          <div className="flex justify-between">
            <button
              type="submit"
              className="inline-flex mt-6 px-8 py-2 text-sm font-medium text-white bg-darkgray rounded-md hover:bg-white hover:text-darkgray outline"
            >
            ...
            {selectedParty && (
              <button
                ...
                className="inline-flex mt-6 px-12 py-2 text-sm font-medium text-white bg-red-500 rounded-md hover:bg-red-900 hover:text-white outline"
              >
                Cancel
              </button>
            )}
          ...
          <tbody>
            {parties.map((party) => (
              <tr key={party._id}>
                      ...
                      >
                        ...
                        <div className="flex">
                          <button
                            ...
                            className="bg-gray text-white py-1 px-2 mt-3 rounded mr-2 ml-4"
                          >
                            Edit
                          </button>
                          <button
                            ...
                            className="bg-red-500 hover:bg-red-700 text-white py-1 px-2 mt-3 rounded mr-2"
                          >
                            Delete
                          </button>
                        </div>
                ...
                <td className="border p-2 font-semibold flex flex-col space-y-4">
                  <button
                    onClick={() => editParty(party)}
                    className="bg-gray text-white py-1 px-2 rounded mr-2 font-login"
                  >
                    Edit
                  </button>
                  <button
                    onClick={() => openModal("deleteParty", party._id)}
                    className="bg-red-500 hover:bg-red-700 text-white py-1 px-2 rounded mr-2 font-login"
                  >
                    Delete
                  </button>
                  <button
                    onClick={() => addQualityToParty(party._id)}
                    className="bg-header text-darkgray py-1 px-2 rounded font-login"
                  >
                    Add Quality
                  </button>
                </td>
