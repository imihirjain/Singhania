...
const RegisterUser = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      await axios.post(
        "https://singhania-inventory.onrender.com/api/auth/register",
        formData
      );
  ...
  return (
    <div className="flex flex-col items-center mt-8">
      <div className="container mx-auto">
        <h2 className="text-2xl font-login font-bold mb-4 text-center">
          Register User
        </h2>
        ...
        <table className="min-w-full divide-y divide-gray-200 border-2 border-darkgray">
